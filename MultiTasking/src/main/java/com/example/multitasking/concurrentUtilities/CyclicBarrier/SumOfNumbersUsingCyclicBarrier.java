package com.example.multitasking.concurrentUtilities.CyclicBarrier;
...
public class SumOfNumbersUsingCyclicBarrier {
    ...
    public static void main(String[] args) throws BrokenBarrierException, InterruptedException, ExecutionException {
        ...
        cyclicBarrier.await();
        System.out.println("First sum calculated!");

        System.out.println("Calculating second sum... ");
        cyclicBarrier.await();
        System.out.println("Second sum calculated!");

        System.out.println("Calculating third sum... ");
        cyclicBarrier.await();
        System.out.println("Third sum calculated!");
