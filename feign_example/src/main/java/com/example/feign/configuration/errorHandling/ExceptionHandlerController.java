package com.example.feign.configuration.errorHandling;


import com.example.feign.domain.exceptions.SlackTokenAuthException;
import com.example.feign.domain.responses.ErrorResponse;
...
public class ExceptionHandlerController {
    ...
    public ErrorResponse handleGenericException(Exception ex) {
        ...
        final String message = "Unexpected problem encountered. Please contact support team with timestamp ["
